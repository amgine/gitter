...
abstract class BinaryParserBasedFunctionImpl<TParameters, TOutput>(ICommandExecutor commandExecutor)
	: IGitFunction<TParameters, TOutput>
	where TParameters : class
{
	protected abstract Command CreateCommand(TParameters parameters);

	protected abstract IBinaryParser<TOutput> CreateParser();
	...
	public TOutput Invoke(TParameters parameters)
	{
		...
		try
		{
			var stdOutReceiver = new AsyncBinaryParser(parser);
