...
/// <summary>Provide contents or details of repository objects.</summary>
public sealed class CatFileCommand : Command
{
	...
	public static ICommandArgument MailMap()
		=> new CommandFlag("--mail-map");

	public static ICommandArgument NoMailMap()
		=> new CommandFlag("--no-mail-map");
