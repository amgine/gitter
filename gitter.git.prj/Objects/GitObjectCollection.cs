namespace gitter.Git
{
	...
	public abstract class GitObjectCollection<TObject, TEventArgs> : GitObject, INotifyCollectionChanged, IEnumerable<TObject>
		...
		where TEventArgs : ObjectEventArgs<TObject>
	{
		...
		/// <summary>Initializes a new instance of the <see cref="GitObjectCollection&lt;TObject, TEventArgs&gt;"/> class.</summary>
		...
		protected GitObjectCollection(Repository repository)
