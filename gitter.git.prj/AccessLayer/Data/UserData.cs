namespace gitter.Git.AccessLayer
{
	...
	public sealed class UserData : INamedObject, IObjectData<User>
	{
		#region Data
		...
		{
			obj.Commits = _commits;
		}

		public User Construct(IRepository repository)
		{
			return new User((Repository)repository, _name, _email, _commits);
		}
