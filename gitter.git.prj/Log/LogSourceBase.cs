...
public abstract class LogSourceBase(Repository repository) : ILogSource
{
	public Repository Repository { get; } = repository;

	protected RevisionLog CreateLog(IList<RevisionData> response)
	{
		var revisions = Repository.Revisions.Resolve(response);
