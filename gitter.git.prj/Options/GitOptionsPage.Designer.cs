namespace gitter.Git
{
	partial class GitOptionsPage
	{
		...
		private void InitializeComponent()
		{
			...
			this._pnlmSysGitOptions = new System.Windows.Forms.Panel();
			...
			this._pnlmSysGitOptions.SuspendLayout();
			this.SuspendLayout();
			// 
			...
			this._lblPathToGitExe.Location = new System.Drawing.Point(0, 5);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this._txtmSysGitPath.Location = new System.Drawing.Point(3, 29);
			...
			this._cmdAutoDetect.Location = new System.Drawing.Point(270, 58);
			...
			this._lblFoundVersion.Location = new System.Drawing.Point(0, 62);
			...
			this._cmdBrowse.Location = new System.Drawing.Point(376, 58);
			...
			this._lblVersion.Location = new System.Drawing.Point(114, 62);
			...
			this._radAlwaysAutodetect.Location = new System.Drawing.Point(117, 3);
			...
			this._radSpecifyManually.Location = new System.Drawing.Point(270, 3);
			...
			// _pnlmSysGitOptions
			// 
			this._pnlmSysGitOptions.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this._pnlmSysGitOptions.Controls.Add(this._lblLatestVersionValue);
			this._pnlmSysGitOptions.Controls.Add(this._lblLatestVersion);
			this._pnlmSysGitOptions.Controls.Add(this._btnDownload);
			this._pnlmSysGitOptions.Controls.Add(this._btnRefreshLatestVersion);
			this._pnlmSysGitOptions.Controls.Add(this._chkFallbackToAnsi);
			this._pnlmSysGitOptions.Controls.Add(this._chkLogCLICalls);
			this._pnlmSysGitOptions.Controls.Add(this._lblPathToGitExe);
			this._pnlmSysGitOptions.Controls.Add(this._radSpecifyManually);
			this._pnlmSysGitOptions.Controls.Add(this._txtmSysGitPath);
			this._pnlmSysGitOptions.Controls.Add(this._radAlwaysAutodetect);
			this._pnlmSysGitOptions.Controls.Add(this._cmdAutoDetect);
			this._pnlmSysGitOptions.Controls.Add(this._lblVersion);
			this._pnlmSysGitOptions.Controls.Add(this._lblFoundVersion);
			this._pnlmSysGitOptions.Controls.Add(this._cmdBrowse);
			this._pnlmSysGitOptions.Location = new System.Drawing.Point(0, 54);
			this._pnlmSysGitOptions.Name = "_pnlmSysGitOptions";
			this._pnlmSysGitOptions.Size = new System.Drawing.Size(479, 163);
			this._pnlmSysGitOptions.TabIndex = 14;
			// 
			// _lblLatestVersionValue
			// 
			this._lblLatestVersionValue.AutoSize = true;
			this._lblLatestVersionValue.Location = new System.Drawing.Point(114, 91);
			...
			this._lblLatestVersion.Location = new System.Drawing.Point(0, 91);
			...
			this._btnDownload.Location = new System.Drawing.Point(376, 87);
			...
			this._btnRefreshLatestVersion.Location = new System.Drawing.Point(270, 87);
			...
			this._chkFallbackToAnsi.Location = new System.Drawing.Point(3, 138);
			...
			this._chkLogCLICalls.Location = new System.Drawing.Point(3, 116);
			...
			this.Controls.Add(this._pnlmSysGitOptions);
			...
			this._pnlmSysGitOptions.ResumeLayout(false);
			this._pnlmSysGitOptions.PerformLayout();
		...
		private System.Windows.Forms.Panel _pnlmSysGitOptions;
