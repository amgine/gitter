namespace gitter.Git.Gui.Controls
{
		...
		where TEventArgs : ObjectEventArgs<TObject>
	{
		...
		private readonly GitObjectCollection<TObject, TEventArgs> _collection;
		...
		protected BaseListBinding(CustomListBoxItemsCollection itemHost, GitObjectCollection<TObject, TEventArgs> collection)
		{
		...
		public GitObjectCollection<TObject, TEventArgs> Source
		{
