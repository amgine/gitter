...
public static class IconPackDiscovery
{
	...
	/// <summary>
	/// Discovers all icon packs: the bundled pack(s) shipped in the iconpacks assembly,
	/// followed by any subdirectory of <paramref name="userPacksDir"/> that contains an icon-theme.json.
	/// </summary>
