...
partial class AboutDialog
{
	...
	private void InitializeComponent()
	{
		...
		this.label1.Text = "Some Icons are Copyright © Yusuke Kamiyamane. All rights reserved. Licensed under a Creative Commons Attribution 3.0 license.";
		// 
		// _logoPictureBox
		// 
		this._logo.Dock = System.Windows.Forms.DockStyle.Top;
		this._logo.Location = new System.Drawing.Point(0, 0);
		this._logo.Size = new System.Drawing.Size(500, 90);
		this._logo.TabIndex = 13;
		...
		this.labelCompanyName.Text = "gitter is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License.";
