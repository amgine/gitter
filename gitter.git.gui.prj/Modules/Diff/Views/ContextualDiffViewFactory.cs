...
sealed class ContextualDiffViewFactory : GitViewFactoryBase<DiffView>
{
	public ContextualDiffViewFactory()
		: base(Guids.ContextualDiffViewGuid, Resources.StrContextualDiff, Icons.Diff, singleton: true)
	{
