...
abstract class HistoryViewBase : GitViewBase, ISearchableView<HistorySearchOptions>
{
	...
	protected HistoryViewBase(Guid guid, GuiProvider gui, IFactory<RevisionListBox> revisionListBoxFactory)
		: base(guid, gui)
	{
		Verify.Argument.IsNotNull(revisionListBoxFactory);

		SuspendLayout();
		AutoScaleDimensions = new SizeF(96F, 96F);

		RevisionListBox = revisionListBoxFactory.Create();
		RevisionListBox.BorderStyle		= BorderStyle.None;
		RevisionListBox.Dock			= DockStyle.Fill;
		RevisionListBox.ShowStatusItems	= true;
		RevisionListBox.Multiselect		= true;
		RevisionListBox.Text			= Resources.StrsNoCommitsToDisplay;
		RevisionListBox.Parent          = this;
