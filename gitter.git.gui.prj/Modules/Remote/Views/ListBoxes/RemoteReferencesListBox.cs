...
public class RemoteReferencesListBox : CustomListBox
{
	...
	{
		public GroupItem(string name, IImageProvider icon)
			: base(name)
		{
			Icon = icon;
		}
	...
	{
		_grpBranches = new GroupItem(Resources.StrHeads, Icons.Branches) { IsExpanded = true };
		_grpTags     = new GroupItem(Resources.StrTags,  Icons.Tags)     { IsExpanded = true };
