...
public sealed class SystemRadioButtonAdapter : WidgetAdapter<RadioButton>, IRadioButtonWidget
{
	...
	public SystemRadioButtonAdapter() : base(new())
	{
		_control.FlatStyle = FlatStyle.System;
		_control.CheckedChanged += OnRadioButtonCheckedChanged;
	}
