...
public sealed class CustomRadioButtonAdapter : WidgetAdapter<CustomRadioButton>, IRadioButtonWidget
{
	...
	public CustomRadioButtonAdapter(CustomRadioButtonRenderer renderer)
		: base(new() { Renderer = renderer })
	{
		_control.IsCheckedChanged += OnRadioButtonIsCheckedChanged;
	}
