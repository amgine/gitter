...
public class SubItemPaintEventArgs : ItemPaintEventArgs, IDpiConverterProvider
{
	...
	/// <summary>Paint image content.</summary>
	/// <param name="imageProvider"><see cref="IImageProvider"/> of the image to pant.</param>
	public void PaintImage(IImageProvider imageProvider)
	{
		if(imageProvider is null) return;

		PaintImage(imageProvider.GetImage(16 * Dpi.X / 96));
	}
	...
	/// <param name="brush">Brush to use.</param>
	/// <param name="stringFormat"><see cref="StringFormat"/> to use.</param>
	private void PaintTextCore(ReadOnlySpan<char> text, Font font, Brush brush, StringFormat stringFormat)
	{
	...
	///		<para><paramref name="stringFormat"/> == null.</para>
	/// </exception>
	public void PaintText(ReadOnlySpan<char> text, Font font, Brush brush, StringFormat stringFormat)
	{
		Verify.Argument.IsNotNull(font);
		Verify.Argument.IsNotNull(brush);
		Verify.Argument.IsNotNull(stringFormat);
	...
	///		<para><paramref name="brush"/> == null.</para>
	/// </exception>
	public void PaintText(ReadOnlySpan<char> text, Font font, Brush brush, StringAlignment stringAlignment)
	{
		Verify.Argument.IsNotNull(font);
		Verify.Argument.IsNotNull(brush);
	...
	///		<para><paramref name="brush"/> == null.</para>
	/// </exception>
	public void PaintText(ReadOnlySpan<char> text, Font font, Brush brush)
	{
		Verify.Argument.IsNotNull(font);
		Verify.Argument.IsNotNull(brush);
	...
	///		<para><paramref name="stringFormat"/> == null.</para>
	/// </exception>
	public void PaintText(ReadOnlySpan<char> text, Brush brush, StringFormat stringFormat)
	{
		Verify.Argument.IsNotNull(brush);
		Verify.Argument.IsNotNull(stringFormat);
	...
	/// <param name="stringAlignment"><see cref="StringAlignment"/> to use.</param>
	/// <exception cref="T:System.ArgumentNullException"><paramref name="brush"/> == <c>null</c>.</exception>
	public void PaintText(ReadOnlySpan<char> text, Brush brush, StringAlignment stringAlignment)
	{
		Verify.Argument.IsNotNull(brush);
	...
	/// <param name="brush"><see cref="Brush"/> to use.</param>
	/// <exception cref="T:System.ArgumentNullException"><paramref name="brush"/> == <c>null</c>.</exception>
	public void PaintText(ReadOnlySpan<char> text, Brush brush)
	{
		Verify.Argument.IsNotNull(brush);
	...
	///		<para><paramref name="stringFormat"/> == null.</para>
	/// </exception>
	public void PaintText(ReadOnlySpan<char> text, Font font, StringFormat stringFormat)
	{
		Verify.Argument.IsNotNull(font);
		Verify.Argument.IsNotNull(stringFormat);
	...
	/// <param name="font"><see cref="Font"/> to use.</param>
	/// <exception cref="T:System.ArgumentNullException"><paramref name="font"/> == <c>null</c>.</exception>
	public void PaintText(ReadOnlySpan<char> text, Font font)
	{
		Verify.Argument.IsNotNull(font);
	...
	/// <param name="text">Text to paint.</param>
	/// <param name="stringFormat"><see cref="StringFormat"/> to use.</param>
	public void PaintText(ReadOnlySpan<char> text, StringFormat stringFormat)
	{
		Verify.Argument.IsNotNull(stringFormat);
	...
	private void PaintImageAndTextCore(Image image, Size imageDrawSize, IImagePainter imagePainter, string text, Font font, Brush brush, StringFormat stringFormat)
	{
		...
		if(image is not null)
		{
			...
			if(w == 0 || h == 0)
			{
				w = conv.ConvertX(ListBoxConstants.DefaultImageWidth);
				h = conv.ConvertY(ListBoxConstants.DefaultImageHeight);
			}
			...
			var imageBounds = new Rectangle(rect.X + before, rect.Y + (rect.Height - h) / 2, w, h);
			if(imagePainter is null)
			{
				Graphics.DrawImage(image, imageBounds);
			}
			else
			{
				imagePainter.Paint(Graphics, image, imageBounds);
			}
