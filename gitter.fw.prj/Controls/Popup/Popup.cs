...
public partial class Popup : ToolStripDropDown
{
	...
	public Popup(Control content)
	{
		...
		if(content is ExtenderBase extender)
		{
			extender.Dock = DockStyle.Fill;
			var size = extender.ScalableSize.GetValue(Dpi.FromControl(extender));
			Size = size;
			_host.Size = size;
	...
	private bool OnNcHitTest(ref Message m, bool contentControl)
	{
		...
		var transparent = new IntPtr(Constants.HTTRANSPARENT);
	...
	private void PaintSizeGrip(PaintEventArgs e)
	{
		...
		if(e is null || e.Graphics is null || !_resizable)
			return;
