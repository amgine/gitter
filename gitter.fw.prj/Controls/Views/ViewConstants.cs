...
static class ViewConstants
{
	...
	public static readonly IDpiBoundValue<Size> Spacing = DpiBoundValue.Size(new(6, 6));

	public const int BeforeTabContent = 3;
	public const int AfterTabContent = 6;
	public const int ImageSpacing = 3;

	public static readonly IDpiBoundValue<int> MinimumHostWidth  = DpiBoundValue.ScaleX(100);
	public static readonly IDpiBoundValue<int> MinimumHostHeight = DpiBoundValue.ScaleY(100);
