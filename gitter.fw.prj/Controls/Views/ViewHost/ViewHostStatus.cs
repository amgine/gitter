...
public enum ViewHostStatus
{
	...
	Offscreen,
	/// <summary><see cref="ViewHost"/> is docked inside <see cref="DockPanel"/> or <see cref="ViewSplit"/>.</summary>
	Docked,
	...
	Floating,
	/// <summary><see cref="ViewHost"/> is docked inside <see cref="DockPanelSide"/>.</summary>
	AutoHide,
