...
/// <summary>
/// Abstraction over file/folder icon retrieval. The default implementation
/// uses the legacy <see cref="IconCache"/>; alternative implementations
/// (e.g. VSCode-style icon packs) plug in here without rewiring callers.
/// </summary>
...
/// <summary>
/// Static accessor for the active <see cref="IFileIconProvider"/>. Defaults to
/// a legacy provider that mirrors <see cref="GraphicsUtility.QueryIcon"/>.
/// Replaceable at runtime for icon-pack switching.
/// </summary>
