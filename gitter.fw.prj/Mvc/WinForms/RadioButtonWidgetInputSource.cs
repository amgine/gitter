...
public class RadioButtonWidgetInputSource(IRadioButtonWidget radionButton)
	: WidgetInputSource<IRadioButtonWidget, bool>(radionButton)
{
	...
	protected override void SubscribeToValueChangeEvent()
		=> Widget.IsCheckedChanged += OnControlValueChanged;
