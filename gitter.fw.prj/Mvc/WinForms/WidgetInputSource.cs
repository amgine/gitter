...
public abstract class WidgetInputSource<TWidget, TValue> : IUserInputSource<TValue?>, IWin32ControlInputSource
	where TWidget : class, IWidget
{
	private TValue? _value;
	private bool _isValueValid;

	public WidgetInputSource(TWidget control)
	{
	...
	Control IWin32ControlInputSource.Control => Widget.Control;
}
