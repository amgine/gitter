namespace gitter.Framework
{
	...
	public sealed class AsyncAction<TData> : IAsyncAction
	{
		...
		public void EndInvoke(IAsyncResult asyncResult)
		{
			...
			if(context == null) throw new ArgumentException("Supplied IAsyncResult was not generated by this AsyncAction.", "asyncResult");
			if(context.IsDisposed) throw new ObjectDisposedException("IAsyncResult");
