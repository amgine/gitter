...
sealed class IssueUpdatedAtColumn : DateColumn
{
	public IssueUpdatedAtColumn()
	...
	protected override Comparison<CustomListBoxItem> SortComparison => IssueListItem.CompareByUpdatedAt;

	private static bool TryGetContent(CustomListBoxItem item, out DateTimeOffset value)
	{
		if(item is IssueListItem issue)
		{
			value = issue.DataContext.UpdatedAt;
			return true;
		}
		value = default;
		return false;
