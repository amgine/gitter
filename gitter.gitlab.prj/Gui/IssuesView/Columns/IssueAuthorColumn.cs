...
sealed class IssueAuthorColumn : CustomListBoxColumn
{
	public IssueAuthorColumn()
		: base((int)ColumnId.Author, Resources.StrAuthor, visible: false)
	{
		Width = 140;
	}
	...
	protected override Comparison<CustomListBoxItem> SortComparison => IssueListItem.CompareByAuthor;

	private static Assignee? GetUser(CustomListBoxItem item)
		=> (item as IssueListItem)?.DataContext.Author;
