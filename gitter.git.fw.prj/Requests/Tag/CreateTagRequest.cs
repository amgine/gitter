...
{
	/// <summary>Create <see cref="CreateTagRequest"/>.</summary>
	...
	public CreateTagRequest(string tagName, string taggedObject)
	{
		TagName = tagName;
	...
	public CreateTagRequest(string tagName, string taggedObject, MessageSpecification message)
	{
		TagName = tagName;
		TaggedObject = taggedObject;
	...
	public CreateTagRequest(string tagName, string taggedObject, MessageSpecification message, bool signed)
	{
		TagName = tagName;
		TaggedObject = taggedObject;
		TagType = TagType.Annotated;
	...
	public CreateTagRequest(string tagName, string taggedObject, MessageSpecification message, string keyId)
	{
		TagName = tagName;
		TaggedObject = taggedObject;
		TagType = TagType.Annotated;
	...
	public string TaggedObject { get; set; } = default!;
