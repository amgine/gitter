...
public sealed class CleanFilesRequest
{
	/// <summary>Create <see cref="CleanFilesRequest"/>.</summary>
	public CleanFilesRequest()
	{
	}

	/// <summary>Create <see cref="CleanFilesRequest"/>.</summary>
	/// <param name="path">Path to clean.</param>
	public CleanFilesRequest(string? path)
	{
		Paths = Many.OneOrNone(path);
	}

	/// <summary>Create <see cref="CleanFilesRequest"/>.</summary>
	/// <param name="paths">Paths to clean.</param>
	public CleanFilesRequest(Many<string> paths)
	{
		Paths = paths;
	}
	...
	public Many<string> ExcludePatterns { get; set; }
}
