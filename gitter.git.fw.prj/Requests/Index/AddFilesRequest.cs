...
{
	/// <summary>Create <see cref="AddFilesRequest"/>.</summary>
	...
	public AddFilesRequest(AddFilesMode mode)
	{
		Mode = mode;
	}
	...
	public AddFilesRequest(string? path)
	{
		Paths = path is not null ? path : Many<string>.None;
	}

	/// <summary>Create <see cref="AddFilesRequest"/>.</summary>
	/// <param name="paths">Paths to add.</param>
	public AddFilesRequest(Many<string> paths)
	{
		Paths = paths;
	}
	...
	/// <param name="path">Path to add.</param>
	public AddFilesRequest(AddFilesMode mode, string? path)
	{
		Mode  = mode;
		Paths = path is not null ? path : Many<string>.None;
	}
	...
	/// <param name="mode">Add files mode.</param>
	/// <param name="paths">Paths to add.</param>
	public AddFilesRequest(AddFilesMode mode, Many<string> paths)
	{
		Mode  = mode;
		Paths = paths;
	}
