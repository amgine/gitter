...
public sealed class StashSaveRequest
{
	/// <summary>Create <see cref="StashSaveRequest"/>.</summary>
	public StashSaveRequest()
	{
	}
	...
	public StashSaveRequest(string? message, bool keepIndex, bool includeUntracked)
	{
		Message          = message;
		KeepIndex        = keepIndex;
