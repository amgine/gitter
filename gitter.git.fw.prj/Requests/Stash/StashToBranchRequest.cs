...
public sealed class StashToBranchRequest
{
	/// <summary>Create <see cref="StashToBranchRequest"/>.</summary>
	public StashToBranchRequest()
	{
	}
	...
	public StashToBranchRequest(string stashName, string branchName)
	{
		StashName = stashName;
