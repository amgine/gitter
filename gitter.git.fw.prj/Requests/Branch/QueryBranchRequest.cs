...
public sealed class QueryBranchRequest
{
	/// <summary>Create <see cref="QueryBranchRequest"/>.</summary>
	public QueryBranchRequest()
	{
	}
	...
	public QueryBranchRequest(string branchName, bool isRemote)
	{
