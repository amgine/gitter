...
/// <summary>Parameters for <see cref="IRepositoryAccessor.QueryBranches"/> operation.</summary>
public sealed class QueryBranchesRequest
{
	/// <summary>Create <see cref="QueryBranchesRequest"/>.</summary>
	public QueryBranchesRequest()
	{
	...
	public QueryBranchesRequest(QueryBranchRestriction restriction)
	{
	...
	public QueryBranchesRequest(QueryBranchRestriction restriction, BranchQueryMode mode)
	{
		Restriction = restriction;
		Mode = mode;
	}
	...
	/// <param name="restriction">Restriction on types of branches to return.</param>
	/// <param name="mode">Relation between returned branches and specified <see cref="M:Revision"/> (HEAD if not specified).</param>
	/// <param name="revision">Revision to check according to <paramref name="mode"/>.</param>
	public QueryBranchesRequest(QueryBranchRestriction restriction, BranchQueryMode mode, string revision)
	{
		Restriction = restriction;
		Mode = mode;
		Revision = revision;
