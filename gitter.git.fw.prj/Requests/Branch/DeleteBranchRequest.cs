...
/// <summary>Parameters for <see cref="IRepositoryAccessor.DeleteBranch"/> operation.</summary>
public sealed class DeleteBranchRequest
{
	/// <summary>Create <see cref="DeleteBranchRequest"/>.</summary>
	...
	public DeleteBranchRequest(string branchName, bool remote, bool force)
	{
