...
/// <summary>Parameters for <see cref="IRepositoryAccessor.CreateBranch"/> operation.</summary>
public sealed class CreateBranchRequest
{
	/// <summary>Create <see cref="CreateBranchRequest"/>.</summary>
	...
	public CreateBranchRequest(string branchName, string startingRevision, bool checkout, bool orphan, bool createReflog, BranchTrackingMode trackingMode)
	{
	...
	public string StartingRevision { get; set; } = default!;
