...
public sealed class PruneRemoteRequest
{
	/// <summary>Create <see cref="PruneRemoteRequest"/>.</summary>
	public PruneRemoteRequest()
	{
	}

	/// <summary>Create <see cref="PruneRemoteRequest"/>.</summary>
	/// <param name="remoteName">Remote to prune.</param>
	public PruneRemoteRequest(string remoteName)
	{
