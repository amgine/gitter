...
/// <summary>Parameters for <see cref="IRepositoryAccessor.Push"/> operation.</summary>
public sealed class PushRequest
{
	///	<summary>Create <see cref="PushRequest"/>.</summary>
	public PushRequest()
	{
		ThinPack = true;
	}
	...
	public PushRequest(string repository, PushMode pushMode, Many<string> refspecs)
	{
	...
	public Many<string> Refspecs { get; set; }
