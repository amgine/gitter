...
/// <summary>Parameters for the <see cref="IRepositoryAccessor.Fetch"/> operation.</summary>
public class FetchRequest
{
	/// <summary>Create <see cref="FetchRequest"/>.</summary>
	public FetchRequest()
	{
	}
	...
	public FetchRequest(string repository)
	{
