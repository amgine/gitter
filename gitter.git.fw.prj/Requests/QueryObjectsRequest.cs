...
{
	/// <summary>Create <see cref="QueryObjectsRequest"/>.</summary>
	...
	public QueryObjectsRequest(string @object)
	{
		Objects = @object;
	}
	...
	public QueryObjectsRequest(Many<string> objects)
	{
		Objects = objects;
	}

	/// <summary>List of requested objects.</summary>
	public Many<string> Objects { get; set; }
}
