...
public static class GitConstants
{
	...
	public static readonly DateTime UnixEraStart = DateTime.UnixEpoch;
#else
	/// <summary>1 Jan 1970</summary>
	public static readonly DateTime UnixEraStart = new (1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
#endif

#if NETCOREAPP
	/// <summary>1 Jan 1970</summary>
	public static readonly DateTimeOffset UnixEraStartOffset = DateTimeOffset.UnixEpoch;
#else
	/// <summary>1 Jan 1970</summary>
	public static readonly DateTimeOffset UnixEraStartOffset = new(1970, 1, 1, 0, 0, 0, TimeSpan.Zero);
#endif
